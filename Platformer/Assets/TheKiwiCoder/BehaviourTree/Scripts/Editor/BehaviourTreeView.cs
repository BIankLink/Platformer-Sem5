...
namespace TheKiwiCoder {
    public class BehaviourTreeView : GraphView {
        ...
        public ScriptTemplate[] scriptFileAssets = {
            ...
            new ScriptTemplate{ templateFile=BehaviourTreeSettings.GetOrCreateSettings().scriptTemplateConditionalNode, defaultFileName="NewConditionalNode.cs", subFolder="Conditional" },
        ...
        public override void BuildContextualMenu(ContextualMenuPopulateEvent evt) {
            ...
            }
            {
                ...
                foreach (var type in types)
                {
                    evt.menu.AppendAction($"[Conditonal]/{type.Name}", (a) => CreateNode(type, nodePosition));
                }
            }
